Custom library for use with Sparkfun Pro RF LoRa module

Abstracts away the RH_RFM95.h library and defines custom message types for receiving and sending between the base and nodes.

Information from example Arduino library:
